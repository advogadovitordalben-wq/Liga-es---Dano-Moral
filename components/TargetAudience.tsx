    ...
    <section className="py-12 bg-black px-6 border-b border-gray-900">
      <div className="max-w-4xl mx-auto">
        <div className="bg-red-950/20 border border-red-800/50 rounded-xl p-8 shadow-[0_0_30px_rgba(220,38,38,0.05)]">
          {/* Aumentei o mb-6 para mb-10 (mais espaço) e adicionei uppercase (caixa alta) */}
          <h2 className="text-xl md:text-2xl font-serif font-bold text-white mb-10 flex flex-col md:flex-row items-center gap-4 text-center md:text-left tracking-wide">
            <span className="text-red-500 text-4xl font-sans">⚠️</span> 
            <span className="uppercase">ATENÇÃO! ESTE PROCEDIMENTO PODE SER PARA VOCÊ SE:</span>
          </h2>
